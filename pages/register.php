        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="../db/sendOTP.php" method="POST">
                ...
                <input  class="btn btn-primary d-grid w-100" value="Sign up" name="register" type="submit">
              </form>
